...
import time as t
import random
account_list=[74185296300,96385274100,78945612300,32165498700]
pin_list=[887253,987214,628389,740011]
balance_list=[70000,40000,30000,10000]
account_holder=["Ishaan Khullar","Avinash Dhanuka","Jaskaran Singh Adhen","Pranav Pandey"]
pass_book=[]

#def1
def check_balance(a):
    print("Your Current Account Balance is :  ",balance_list[a])
        ...
        if a1==1:
            ...
            if "@" in UPI:
                ...
                if UPI[Index+1:] in UPI_id and UPI[:Index].isalnum:
                    ...
                    if Amount<=int(balance_list[a]) :
                        balance_list[a]=balance_list[a]-Amount
                        t.sleep(1.5)
                        print("Amount Rs.",Amount,"sent to UPI id:",UPI)
                        Date=datetime.datetime.now().strftime("%B %d, %Y")
                        Time=datetime.datetime.now().strftime("%X")
                        History="Amount Rs",Amount,"sent to","UPI id:",UPI,"on",Date,"at",Time,"Closing balance:",balance_list[a]
                        pass_book.append(History)
                        print("Current Balance is",balance_list[a])
                    elif Amount>balance_list[a]:
        ...
        if a1==2:
            ...
            if len(str(Bank_Account))==11:
                ...
                if Amount<=int(balance_list[a]):
                    ...
                    Date=datetime.datetime.now().strftime("%B %d, %Y")
                    Time=datetime.datetime.now().strftime("%X")
                    History="Amount Rs",Amount,"sent to","Account Number:",Bank_Account,"on",Date,"at",Time,"Closing balance:",balance_list[a]
                    pass_book.append(History)
                elif Amount>balance_list[a]:
                    print("---Insufficient Balance!!!---")
            else:
        ...
        if a1==3:
            ...
            if len(str(Mobile_Number))==10 and int(str(Mobile_Number)[0]) not in rejected_list:
                ...
                if Amount<=int(balance_list[a]):
                    ...
                    Date=datetime.datetime.now().strftime("%B %d, %Y")
                    Time=datetime.datetime.now().strftime("%X")
                    History="Amount Rs",Amount,"sent to","Mobile Number:",Mobile_Number,"on",Date,"at",Time,"Closing balance:",balance_list[a]
                    pass_book.append(History)
                elif Amount>balance_list[a]:
                    print("---Insufficient Balance!!!---")
                    t.sleep(1.5)
...
while (num_of_tries!=0):
    ...
    if(check_acc_num in account_list and check_pin in pin_list and (account_list.index(check_acc_num)==pin_list.index(check_pin))):
        #ACCOUNT 1
        a = account_list.index(check_acc_num)
